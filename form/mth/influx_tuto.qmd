...
In `.condarc` (shoud be in your \$HOME/miniconda3/), replace the chain "defaults" by "nodefaults" and add "conda-forge" and "bioconda":
...
Open "Anaconda promt (miniconda3)" from Windows menu.

In conda terminal create new environment for this tutorial

```         
$ conda create -n tuto influx_si -c bioconda -c conda-forge
$ conda activate tuto
```
...
-   moreover, we want just a simulation (not flux estimations) (`--noopt`)
